...
require("lazy").setup({
    ...
    {'https://github.com/sharkdp/fd.git'}, {'hrsh7th/cmp-nvim-lsp'},
    {'hrsh7th/cmp-buffer'}, {'hrsh7th/cmp-path'}, {'hrsh7th/cmp-cmdline'},
    {'hrsh7th/nvim-cmp'}, {'neovim/nvim-lspconfig'}, {'hrsh7th/cmp-vsnip'},
    {'hrsh7th/vim-vsnip'}, {'tpope/vim-repeat'}, -- " Docstrings
    {
        "danymat/neogen",
    ...
    {'yuezk/vim-js'}, {'maxmellon/vim-jsx-pretty', lazy = true},
    {'nvim-lua/plenary.nvim'}, {'nvim-pack/nvim-spectre'}, {'junegunn/fzf'},
    {'junegunn/fzf.vim'}, {
